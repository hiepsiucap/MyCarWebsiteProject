...
public class RevenueDTO {
    ...
    public RevenueDTO(int totalCar, int totalRevenue, int totalRent, List<Integer> monthRevenue, List<Integer> monthRent, List<String> topCar, List<Integer> topRentCar) {
