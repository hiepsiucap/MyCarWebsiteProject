...
export const TimeNow= (dateChoose)=>{
  ...
  if(d.getDay()== dateChoose.getDay()&& d.getMonth()== dateChoose.getMonth() && d.getFullYear()===dateChoose.getFullYear())
  {
     ...
     for(let i=hour+1;i<=23;i=i+1)
     {
      if(i <10)
        {
         filtertime.push(`0${i}:00`);
         filtertime.push(`0${i}:30`);
        }
        else{
...
export const DetailCar={
  ...
  fuel: "Xăng",
  consumption: 7,
  description: "Mercedes-Benz G63 là một dòng xe SUV cao cấp của hãng xe Đức Mercedes-Benz, nổi tiếng với thiết kế mạnh mẽ và sang trọng. Xe được trang bị động cơ V8 tăng áp kép mạnh mẽ, hệ thống lái và treo được cải tiến để vận hành linh hoạt trên mọi loại địa hình. Nội thất của G63 được trang bị với các vật liệu cao cấp và tính năng tiện nghi hiện đại. Đặc biệt, Mercedes-Benz cung cấp các phiên bản đặc biệt và tùy chọn cá nhân hóa cho G63, giúp khách hàng có nhiều sự lựa chọn phong phú. Tóm lại, G63 là một dòng xe SUV mạnh mẽ, đa năng và sang trọng, phù hợp cho những người đam mê khám phá và yêu thích tiện nghi cao cấp.",
  cost: 390000,
  district: "Quận 1",
  province: "Hồ Chí Minh",
  address: " Dinh Độc Lập",
  days: ["2024-05-19","2024-05-20","2024-05-21","2024-05-22"],
  reviews: [
    {
      ava: "https://res.cloudinary.com/dhhuv7n0h/image/upload/v1710901348/rfb0bgnjivk8cujez1ft.jpg",
      user_id: "abv11213123213123123",
      name: "Nguyễn Hồng Hiệp",
      rate: 5,
      detail: "chủ xe giao xe sạch sẽ, xe chạy êm, ổn định.s",
      date: "2024-05-19",
    },
     {
      ava: "https://res.cloudinary.com/dhhuv7n0h/image/upload/v1710901348/rfb0bgnjivk8cujez1ft.jpg",
      ...
      name: "Nguyễn Hồng Hiệp",
      rate: 3,
      detail: "chủ xe giao xe sạch sẽ, xe chạy êm, ổn định.",
      date: "2024-05-19",
    },
     {
      ava: "https://res.cloudinary.com/dhhuv7n0h/image/upload/v1710901348/rfb0bgnjivk8cujez1ft.jpg",
  ...
  image:{
    mainimage:"https://res.cloudinary.com/dhhuv7n0h/image/upload/v1715494468/r6s7b9itggwtpzycc4fg.jpg",
    image1: "https://res.cloudinary.com/dhhuv7n0h/image/upload/v1715927076/detail5_aff2i1.jpg",
    image2: "https://res.cloudinary.com/dhhuv7n0h/image/upload/v1715927078/detail6_lnoog5.jpg",
    image3: "https://res.cloudinary.com/dhhuv7n0h/image/upload/v1715927109/detail7_gtkq2r.jpg",
    image4: "https://res.cloudinary.com/dhhuv7n0h/image/upload/v1715927109/detail7_gtkq2r.jpg",
  }
}
export const ListOfCar= [
  ...
  gear: "Số tự động",
  fuel: "Xăng",
  image: "https://res.cloudinary.com/dhhuv7n0h/image/upload/v1715928289/detail1_zzvjvm.png",
  description: "Mercedes-Benz G63 là một dòng xe SUV cao cấp của hãng xe Đức Mercedes-Benz, nổi tiếng với thiết kế mạnh mẽ và sang trọng. Xe được trang bị động cơ V8 tăng áp kép mạnh mẽ, hệ thống lái và treo được cải tiến để vận hành linh hoạt trên mọi loại địa hình. Nội thất của G63 được trang bị với các vật liệu cao cấp và tính năng tiện nghi hiện đại. Đặc biệt, Mercedes-Benz cung cấp các phiên bản đặc biệt và tùy chọn cá nhân hóa cho G63, giúp khách hàng có nhiều sự lựa chọn phong phú. Tóm lại, G63 là một dòng xe SUV mạnh mẽ, đa năng và sang trọng, phù hợp cho những người đam mê khám phá và yêu thích tiện nghi cao cấp.",
  cost: 390000,
  district: "Quận 1",
  province: "Hồ Chí Minh",
  address: " Dinh Độc Lập",
  number_of_rental: 1000,
  car_id: "123",
  },
  {
  name: "Mercedes-Benz G63 AMG 2023",
...
export const UserInfo= {
    ...
    first_name : "Nguyễn",
    last_name: "Hồng Hiệp",
    email: "billhiepnguyen@gmail.com",
    phone_number: "0914076826",
...
export const revenue= {
  ...
  totalrent: 1000,
  monthrevenue: [100, 120, 150, 200, 150, 120, 200, 50, 60, 70, 80 , 70],
  monthrent: [100, 120, 150, 200, 250, 300, 350, 200, 450, 500, 525 , 550],
  topcar: [
  "Toyota Vios",
  "Toyota Innova",
  "Toyota Fortuner",
...
toprentcar: [1380, 1200, 1100, 690, 580, 540, 470, 448, 430, 400]
}
